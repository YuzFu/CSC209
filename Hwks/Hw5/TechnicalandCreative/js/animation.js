document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("animate").addEventListener("click", movePoint);
    document.getElementById("stop").addEventListener("click", stopPoint);
    document.getElementById("reset").addEventListener("click", resetPoint);
    document.getElementById("generateRandom").addEventListener("click", randomPoint);
    document.getElementById("NRPTS").addEventListener("change", initializePoint);
